...
ALTER TABLE default_table REPLICA IDENTITY FULL;
...
ALTER TABLE numeric_table REPLICA IDENTITY FULL;
...
ALTER TABLE numeric_decimal_table REPLICA IDENTITY FULL;
...
ALTER TABLE text_table REPLICA IDENTITY FULL;

DROP TABLE IF EXISTS geom_table;
CREATE TABLE geom_table (pk SERIAL, p POINT, PRIMARY KEY(pk));
ALTER TABLE geom_table REPLICA IDENTITY FULL;
...
ALTER TABLE range_table REPLICA IDENTITY FULL;
...
ALTER TABLE array_table REPLICA IDENTITY FULL;
...
ALTER TABLE postgis_table REPLICA IDENTITY FULL;
...
ALTER TABLE postgis_array_table REPLICA IDENTITY FULL;
...
ALTER TABLE timezone_table REPLICA IDENTITY FULL;
...
ALTER TABLE col_has_special_character_table REPLICA IDENTITY FULL;