...
CREATE TABLE ape_trans_pg.topo1_node2_to_node3 (n integer PRIMARY KEY);
insert into ape_trans_pg.topo1_node2_to_node3 (n) values (0);

CREATE TABLE ape_trans_pg.topo1_node1_to_node3 (n integer PRIMARY KEY);
insert into ape_trans_pg.topo1_node1_to_node3 (n) values (0);