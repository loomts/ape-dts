...
-- TODO, scalar json objects may lose precision in binlog.
-- for example, INSERT INTO test_db_1.json_test VALUES (NULL, CAST(CAST('23:24:25' AS TIME) AS JSON)), the result will be:
-- +-----+--------------------------+
-- | f_0 | f_1                  |
-- |  1  | "23:24:25.000000"    |
-- but in binlog, we get f_1: 23:24:25
