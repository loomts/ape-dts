...
DROP TABLE IF EXISTS test_db_1.default_table;
...
DROP TABLE IF EXISTS test_db_1.numeric_table;
...
DROP TABLE IF EXISTS test_db_1.numeric_decimal_table;
...
DROP TABLE IF EXISTS test_db_1.string_table;
