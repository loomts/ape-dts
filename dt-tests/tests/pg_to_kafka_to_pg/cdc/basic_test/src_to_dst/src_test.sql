...
UPDATE test_db_1.numeric_table SET si=1, i=123456, bi=1234567890123, r=3.3, db=4.44, r_int=3, db_int=4, r_nan='NaN', db_nan='NaN', r_pinf='Infinity', db_pinf='Infinity', r_ninf='-Infinity', db_ninf='-Infinity', ss=1, bs=123, b=true, o=4000000000 WHERE pk=2;
UPDATE test_db_1.numeric_table SET si=NULL, i=NULL, bi=NULL, r=NULL, db=NULL, r_int=NULL, db_int=NULL, r_nan=NULL, db_nan=NULL, r_pinf=NULL, db_pinf=NULL, r_ninf=NULL, db_ninf=NULL, ss=2, bs=321, b=NULL, o=NULL WHERE pk=1;
...
UPDATE test_db_1.numeric_decimal_table SET d=1.1, dzs=10.11, dvs=10.1111, d_nn=3.30, n=22.22, nzs=22.2, nvs=22.2222, d_int=1, dzs_int=10, dvs_int=10, n_int=22, nzs_int=22, nvs_int=22, d_nan='NaN', dzs_nan='NaN', dvs_nan='NaN', n_nan='NaN', nzs_nan='NaN', nvs_nan='NaN' WHERE pk=2;
UPDATE test_db_1.numeric_decimal_table SET d=NULL, dzs=NULL, dvs=NULL, d_nn=NULL, n=NULL, nzs=NULL, nvs=NULL, d_int=NULL, dzs_int=NULL, dvs_int=NULL, n_int=NULL, nzs_int=NULL, nvs_int=NULL, d_nan=NULL, dzs_nan=NULL, dvs_nan=NULL, n_nan=NULL, nzs_nan=NULL, nvs_nan=NULL WHERE pk=1;
DELETE FROM test_db_1.numeric_decimal_table;
...
UPDATE test_db_1.string_table SET vc='žš', vcv='bb', ch='cdef', c='abc', t='some text', b=E'\\000\\001\\002'::bytea, bnn=E'\\003\\004\\005'::bytea, ct='Hello World' WHERE pk=2;
UPDATE test_db_1.string_table SET vc=NULL, vcv=NULL, ch=NULL, c=NULL, t=NULL, b=NULL, bnn=NULL, ct=NULL WHERE pk=1;
DELETE FROM test_db_1.string_table;
