...
CREATE TABLE `full_column_type` (
  ...
  `smallserial_col` smallint(6) NOT NULL COMMENT "",
  `serial2_col` smallint(6) NOT NULL COMMENT "",
  `integer_col` int(11) NULL COMMENT "",
  `int_col` int(11) NULL COMMENT "",
  `int4_col` int(11) NULL COMMENT "",
  `serial_col` int(11) NOT NULL COMMENT "",
  `serial4_col` int(11) NOT NULL COMMENT "",
  `bigint_col` bigint(20) NULL COMMENT "",
  `int8_col` bigint(20) NULL COMMENT "",
  `bigserial_col` bigint(20) NOT NULL COMMENT "",
  `serial8_col` bigint(20) NOT NULL COMMENT "",
