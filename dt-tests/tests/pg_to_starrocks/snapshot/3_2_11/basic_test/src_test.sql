...
-- 'NaN', 'Infinity' are NOT supported in StarRocks
...
INSERT INTO macaddr_table (pk, m) VALUES (2, '08:00:2b:01:02:03');
...
-- infinity, BC are NOT supported in StarRocks 
...
INSERT INTO custom_table (pk, lt, i, n, lt_array) VALUES (1, 'Top.Collections.Pictures.Astronomy.Galaxies', '978-0-393-04002-9', null, '{"Ship.Frigate","Ship.Destroyer"}');
...
INSERT INTO public.postgis_table (pk, p, ml) VALUES (1, 'SRID=3187;POINT(174.9479 -36.7208)'::geometry, 'MULTILINESTRING((169.1321 -44.7032, 167.8974 -44.6414))'::geography);
INSERT INTO public.postgis_table (pk, p, ml) VALUES (2, NULL, NULL);
