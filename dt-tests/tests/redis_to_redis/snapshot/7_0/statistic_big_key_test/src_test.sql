-- these commands are used to generate dump.rdb for test.
-- they won't be executed during tests, you should execute them manually.
...
SET 1-1 "abcdefghijklmnopqrstuvwxyz"
