...
-- TODO, PFCOUNT 45-3 returns same results in 2.8 and 7.*, which is expected
-- GET 45-3 returns different results in 2.8 and 7.*, but GET should not be used to check HyperLogLog keys
-- refer: https://redis.io/docs/data-types/probabilistic/hyperloglogs/
...
-- SWAPDB -- version: 4.0.0
-- SWAPDB 0 1

-- UNLINK --version: 4.0.0
-- SET 64-1 "Hello"
-- SET 64-2 "World"
