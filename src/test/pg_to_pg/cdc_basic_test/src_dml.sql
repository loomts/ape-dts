...
UPDATE public.postgis_table SET p='SRID=3187;POINT(174.9479 -36.7208)'::geometry, ml='MULTILINESTRING((169.1321 -44.7032, 167.8974 -44.6414))'::geography WHERE pk=2;
UPDATE public.postgis_table SET p=NULL, ml=NULL WHERE pk=1;
...
UPDATE public.postgis_array_table SET ga=ARRAY['GEOMETRYCOLLECTION EMPTY'::geometry], gann=ARRAY['GEOMETRYCOLLECTION EMPTY'::geometry, 'POLYGON((166.51 -46.64, 178.52 -46.64, 178.52 -34.45, 166.51 -34.45, 166.51 -46.64))'::geometry] WHERE pk=2;
UPDATE public.postgis_array_table SET ga=NULL, gann=NULL WHERE pk=1;
