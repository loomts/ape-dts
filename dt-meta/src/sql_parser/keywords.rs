...
// copied from https://github.com/ms705/nom-sql/blob/master/src/keywords.rs
...
pub(crate) fn keyword_a_to_c(i: &[u8]) -> IResult<&[u8], &[u8]> {
    alt((
...
pub(crate) fn keyword_c_to_e(i: &[u8]) -> IResult<&[u8], &[u8]> {
    alt((
...
pub(crate) fn keyword_e_to_i(i: &[u8]) -> IResult<&[u8], &[u8]> {
    alt((
...
pub(crate) fn keyword_i_to_o(i: &[u8]) -> IResult<&[u8], &[u8]> {
    alt((
...
pub(crate) fn keyword_o_to_s(i: &[u8]) -> IResult<&[u8], &[u8]> {
    alt((
...
pub(crate) fn keyword_s_to_z(i: &[u8]) -> IResult<&[u8], &[u8]> {
    alt((
