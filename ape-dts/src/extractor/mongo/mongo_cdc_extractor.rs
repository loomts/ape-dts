                    ...
                    match doc.operation_type {
                        ...
                        OperationType::Update | OperationType::Replace => {
                            ...
                            let id = doc
                                ...
                                .as_ref()
                                .unwrap()
                                .get_object_id(Mongo::ID)
                                .unwrap();
                            let before_doc = doc! {Mongo::ID: id};
                            let after_doc = doc.full_document.unwrap();
                            before.insert(Mongo::DOC.to_string(), ColValue::MongoDoc(before_doc));
                            after.insert(Mongo::DOC.to_string(), ColValue::MongoDoc(after_doc));
                        }
